...
Ctrl+Shift+P → CodeRev: Index Workspace — indexes all supported files in the workspace
Ctrl+Shift+P → CodeRev: Review PR — enter a PR number and wait for the review to appear in a new tab
